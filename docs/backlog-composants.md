...
| [x] | Fil d'Ariane partout | V | 3 | Articles et tags du blog, pages légales, conseil, liste des produits, avec BreadcrumbList ; prop `filAriane` d'EnTetePage (2026-09-05). |
...
| [x] | Carrousel, contraste élevé, retour en haut | V | 3 | Diapositives hors écran `inert`, styles `forced-colors` (glyphes, points, piste, lien courant), retour en haut vers `#haut` (2026-09-05). |
...
| [x] | Échelle typographique ramenée à neuf tailles | V | 3 | 13 · 15 · 17 · 20 · 24 · 30 · 40 · 48 · 64 appliquée partout (2026-09-15). |
