...
- Liens de texte : `cobalt`, sans soulignement, `cobalt-fonce` au survol ;
  dans le corps des articles et des pages éditoriales, soulignés.
...
| Pied de page | `Footer.astro` | Bordure haute `ligne`. Marque, mention « © 2026 Bresnik. Logiciels complémentaires pour l'écosystème Sage 100. Éditeur indépendant, sans lien avec Sage Group plc. », liens Mentions légales, Confidentialité, Flux RSS. L'année est fixée à 2026 (site statique). En mobile : empilé. |
